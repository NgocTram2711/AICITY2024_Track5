...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        '/MLCV/thuann/lab/co_detr/Co-DETR/thuann/data/aicity2024_track5/train.json',
        img_prefix=
        '/MLCV/thuann/lab/co_detr/Co-DETR/thuann/data/aicity2024_track5/train_img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file=
        '/MLCV/thuann/lab/co_detr/Co-DETR/thuann/data/aicity2024_track5/test.json',
        img_prefix=
        '/MLCV/thuann/lab/co_detr/Co-DETR/thuann/data/aicity2024_track5/test_img/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
